...
//R engines for integration and graphing
 ...
 * 
 * TODO: Incorporate the ability to process other scan formats on multiple OSs too. Only outputs .nii, output .nii.gz too?
 * TODO: Change default format from FLOAT to UCHAR or INT? 
...
public class processExvivo {
	...
	public static void main(String args[]) throws IOException {
		...
		if (inputFile.endsWith(".gz")) {
			...
			/**TODO: *always* necessary for opening nifti scan? only do so if it's in .gz format
