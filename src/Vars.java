...
// TODO: Generate an empty constructor for default values and maybe a second one to pass arguments 
// to or edit instances of variables? This is would be very helpful when calling exvivoUI and allowing
// client-defined variables to be passed to the program. 
...
public class Vars {
	...
	static String path1 = "/Desktop/memorycube/"; //path between user ID and subject
	static String path2 = "_FREESURFER/mri/orig/"; //path to location of folder
	static String path3 = "/Desktop/memorycube/"; //path between user ID and subject
